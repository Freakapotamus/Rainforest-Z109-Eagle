 /**
 *  Rainforest Eagle Manager - Service Manager
 *
 *
...
preferences {
    section("Use the values printed on the bottom of your Eagle"){
        input name: "macId", type: "text", title: "MAC Address", required: true, displayDuringSetup: true, defaultValue: "d8d5b900000065b0"
    	input name: "cloudId", type: "text", title: "Cloud ID", required: true, displayDuringSetup: true
        input name: "instCode", type: "text", title: "Install Code", required: true, displayDuringSetup: true
    }
...
def schedule(child) {
	...
	child.refresh()
    // schedule to refresh
    schedule("* /5 * * * ?", "refreshCallback") // every 5 minute
}
